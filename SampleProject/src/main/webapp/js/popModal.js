          ...
          onDocumentClickClosePrevent : '',
				...
				if ( $('body').find('.' + elemClass).length != 0 && $('body').find('.' + elemClass).attr('data-popmodal_id') == elem.attr('data-popmodal_id') ) {
					...
					if (_options.showCloseBut) {
						closeBut = $('<div align="right"><button type="button" class="close">&times;</button></div>');
					}
					...
					var tooltipContainer = $('<div class="' + elemClass + ' animated" style="' + isFixed + '" data-popmodal_id="' + currentID + '" align="right"></div>');
