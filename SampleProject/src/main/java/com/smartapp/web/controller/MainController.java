...
public class MainController {
	...
	@RequestMapping(value={"/login.htm"},params="userAction=authenticate", method = {RequestMethod.GET, RequestMethod.POST})
	public String getSignupPage(HttpServletRequest request, HttpServletResponse response, Model model,@ModelAttribute("userForm") UserForm form){
